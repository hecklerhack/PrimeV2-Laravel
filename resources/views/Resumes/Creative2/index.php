						...
						<div class="row relative">
							<div class="col-xs-12 col-sm-6 static">
								<div class="slider-text percent-50">
									...
									<h1 class="mb-30">
			                            <?php 
			                                $result = $db->get_candidate_user_info("24", 3);
			                                $result1 =$db->get_candidate_user_info("24", 4);
									...
									<p class="font-16 line-height-28" style="padding-left: 2%;">
			                            <?php 
			                                $result2 = $db->get_candidate_user_info("24", 15);
			                                $result3 =$db->get_candidate_user_email("24");
			                                $result4 =$db->get_candidate_user_info("24", 6);
			                                $result5 =$db->get_candidate_user_info("24", 7);
			                                $result6 =$db->get_candidate_user_info("24", 8);
			                                $result14 =$db->get_candidate_user_info("24", 9);
